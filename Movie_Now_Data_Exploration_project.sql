-- Data Exploration of the Movie_Now Database
USE movie_now;
-- This database contains 5 tables which are: actors, actsin, customers, movies, renting


-- ------------------------------------EXPLORING THE DATA
-- 1. Choose only the columns which do not have a null value in their ratings. This is because the ratings have to be there in order to measure
-- customer satisfaction. Use the WHERE clause to set the condition. 
...
-- 2. Count all the customers in the renting database.   
...
-- --------------------------- JOINING TABLES
-- Formulate some business questions to further explore the data
...
-- The question is ' WHO ARE THE FAVOURITE ACTORS FOR A CERTAIN CUSTOMER GROUP?'
